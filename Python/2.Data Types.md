  ...
  <tr>
    <td>
      <ol type="A">
        ...
        <li>float: Floating Point | Decimal Numbers</li>
        <li>complex(7 + j) | Complex Numbers</li>
        <li><strong>bin(7)</strong>: Binary</li>
        <li><strong>oct(7)</strong>: Octal</li>
        <li><strong>hex(7)</strong>: Hexadecimal</li>
      </ol>
    </td>
    <td>
      <ol type="A">
